...
if __name__ == '__main__':
    ...
    parser.add_argument('--no-lya-correction', action='store_true', required=False,
        help='Do not correct for Lyman-alpha absorption')
    ...
    p_fit_line = partial(read_SDSS_data.fit_line, path_spec=args.in_dir, lines=lines, qso_pca=qso_pca,dv_prior=args.dv_prior,
        ...
        cutANDMASK=(not args.no_cut_ANDMASK), dwave_model=args.dwave_model, correct_lya=(not args.no_lya_correction) )
    ...
    head = [ {'name':'DRQ','value':args.drq.split('/')[-1],'comment':'Object catalog with redshift prior'},
            ...
            {'name':'LYAABS','value':(not args.no_lya_correction),'comment':'Correct for Lya absorption'},
